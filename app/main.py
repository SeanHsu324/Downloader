...
def splash_screen(load_windows):
    ...
    splash_img = ctk.CTkImage(img, size=(432, 102))  
...
def choose_color():
    ...
    if color_code:
        ...
        item = [
            dropdown_menu, Image_quality_menu, backgroundcolor_menu, wordlabel, mp3label
        ]
        botton = [
...
def teaching_2():
    ...
    cookie_file = f"{down_path}//cookie.txt"
    os.startfile(cookie_file)
def teaching_3():
    webbrowser.open("https://sites.google.com/view/yt-to-dowload/教學/取得網址")
